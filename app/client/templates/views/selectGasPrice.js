...
var calculateGasInWei = function(template, gas, gasPrice, returnGasPrice){
    ...
    if(_.isUndefined(gas)) {
        console.warn('No gas provided for {{> dapp_selectGasPriceFixed}}');
...
Template['dapp_selectGasPriceFixed'].onCreated(function(){
...
Template['dapp_selectGasPriceFixed'].helpers({
    /**
...
Template['dapp_selectGasPriceFixed'].events({
    /**
